...
<h2 class="text-center" style="color: green"> Garage Available Now </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Garage Rent Available Now</h4>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage2.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage3.jpg" alt="Card image cap">
                <div class="card-body">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage4.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage5.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/garage6.jpg" alt="Card image cap">
                <div class="card-body">
