...
if(isset($_POST['adv'])) {
    ...
    if ($rent_name == "Flat") {
        $rent_type = "Home Rent";
    } else if ($rent_name == "Hostel") {
        $rent_type = "Home Rent";
    } else if ($rent_name == "Sublet") {
        $rent_type = "Home Rent";
    } else if ($rent_name == "Shop") {
        $rent_type = "GroundFloor";
    } else if ($rent_name == "Garage") {
        $rent_type = "GroundFloor";
    } else if ($rent_name == "Car Parking") {
        $rent_type = "GroundFloor";
    } else if ($rent_name == "Store House") {
         $rent_type = "GroundFloor";
    } else if ($rent_name == "Party Center") {
        $rent_type = "CommercialProperty";
    } else if ($rent_name == "Conference Room") {
        $rent_type = "CommercialProperty";
    } else if ($rent_name == "Conventional Hall") {
        $rent_type = "CommercialProperty";
    } else if ($rent_name == "Community Center") {
        $rent_type = "CommercialProperty";
    } else if ($rent_name == "Restaurants") {
        $rent_type = "CommercialProperty";
    } else if ($rent_name == "Bus") {
        $rent_type = "Transportation";
    } else if ($rent_name == "Car") {
         $rent_type = "Transportation";
    } else if ($rent_name == "Truck") {
         $rent_type = "Transportation";
    } else if ($rent_name == "Bike") {
         $rent_type = "Transportation";
    } else if ($rent_name == "Mini Truck") {
          $rent_type = "Transportation";
    } else if ($rent_name == "Clothes") {
         $rent_type = "Decoration";
    } else if ($rent_name == "Ornaments") {
         $rent_type = "Decoration";
    } else if ($rent_name == "Others") {
         $rent_type = "Others";
    } 
    //echo $Rent_type;
    ...
    $available_date = $_POST['A_date'];
    $duration = $_POST['D_date'];
    $description = $_POST['description'];
    $issue_date = date("Y-m-d",time());

    $query = "insert into advertises (user_id, rent_type, rent_name,district,city, area, phone, email, amount, image1, image2,image3, available_date, duration, description, issue_date) values ('$user_id', '$rent_type', '$rent_name','$district','$city', '$area', '$phone', '$email', '$amount', '$image1' , '$image2','$image3', '$available_date', '$duration', '$description', '$issue_date')";
    ...
    $query2 = "select max(add_id) as add_id from advertises";
    $equery = mysqli_query($connect , $query2);
    $maxx = mysqli_fetch_array($equery);
    $addid = $maxx['add_id'];
    $query2 = "insert into pending_advertises (add_id , user_id) values ('$addid' , '$user_id')";
    $equery = mysqli_query($connect , $query2);
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card rounded-0">
                    ...
                    <div class="card-body">
                        <form action="Advertises.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-form-label"> Rent Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="U_Trx_id" class="form-control"required/>
                            </div>
                            --> 
                            ...
                            <div class="form-group"> <!-- Date input -->
                                ...
                                <input class="form-control" id="date" name="A_date" placeholder="YYYY-MM-DD" type="text"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="description" name="description" placeholder="Write in details" type="text"/>
                            </div>


                            <div class="form-group">
                                <label class="col-form-label"></label>
                                <input type="submit" name="adv" class="btn btn-outline-success" value="Make Advertises"/>
                            </div>
