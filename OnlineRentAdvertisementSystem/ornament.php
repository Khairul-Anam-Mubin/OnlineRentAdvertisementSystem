...
<h2 class="text-center" style="color: green"> Ornamnents Rent Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Ornamnents Rent Available Now</h4>
                    <h5>Location : Dhanmondi</h5>

                    <a href="Product.php" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 800/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or2.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-dark">Taka 700/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or3.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 900/day</a>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or4.jpeg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 2500/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or5.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 1000/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/or6.jpg" alt="Card image cap">
                <div class="card-body">
