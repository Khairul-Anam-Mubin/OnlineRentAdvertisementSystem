...
<h2 class="text-center" style="color: green"> Shop Available Now </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Shop Rent Available Now</h4>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop2.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop3.jpg" alt="Card image cap">
                <div class="card-body">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop4.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop5.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/shop6.jpg" alt="Card image cap">
                <div class="card-body">
