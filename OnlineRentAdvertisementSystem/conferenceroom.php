...
<h2 class="text-center" style="color: green"> Conference Room Rent Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Conference Room Rent Available</h4>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf2.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf3.jpg" alt="Card image cap">
                <div class="card-body">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf4.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf5.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cf6.jpg" alt="Card image cap">
                <div class="card-body">
