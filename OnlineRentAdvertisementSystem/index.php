    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="manu">
            <ul class="navbar-nav">
                ...
                <li class="dropdown"><a href="" class="nav-link dropdown-toggle" data-toggle="dropdown">Spaces</a>
                    <ul class="dropdown-menu">
                        <!--sub manu-->
                ...
                <li class="dropdown"><a href="" class="nav-link dropdown-toggle" data-toggle="dropdown">CommercialProperty</a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="" class="dropdown-item"> Convention Hall</a> </li>
                        <li><a href="" class="dropdown-item"> Community Center</a> </li>
                        <li><a href="" class="dropdown-item"> Restaurant</a> </li>
