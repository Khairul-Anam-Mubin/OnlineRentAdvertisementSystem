...
<h2 class="text-center" style="color: green"> Convention Hall Rent Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Convention Hall Rent Available</h4>
                    <h5>Location : Dhanmondi</h5>

                    <a href="Product.php" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 65000/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch2.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-dark">Taka 55000/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch3.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Convention HallRent Available</h4>
                    <h5>Location : Mirpur-1</h5>

                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 40000/day</a>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch4.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 20000/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch5.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 50000/day</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/ch6.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 25000/day</a>
                </div>
            </div>
        </div>
