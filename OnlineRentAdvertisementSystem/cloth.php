...
<h2 class="text-center" style="color: green"> Clothes Rent Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Cloth Rent Available Now</h4>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl2.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl3.jpg" alt="Card image cap">
                <div class="card-body">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl4.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl5.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/cl6.jpg" alt="Card image cap">
                <div class="card-body">
