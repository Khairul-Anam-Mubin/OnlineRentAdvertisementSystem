...
<h2 class="text-center" style="color: green"> Latest Upload Sublet Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/sublet1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Sublate Rent Available Now</h4>
                    <h5>Location : Uttara</h5>

                    <a href="Product.php" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 10000/month</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/sublet4.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-dark">Taka 12000/month</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/sublet3.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Sublet Rent Available Now</h4>
                    <h5>Location : Mirpur-10</h5>

                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 8000/month</a>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/sublet6.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="" class="btn btn-success">Show Details....</a>
                    <a href="" class="btn btn-dark">Taka 11000/month</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/sublet7.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Sublet Rent Available Now</h4>
                    <h5>Location : Banani</h5>
