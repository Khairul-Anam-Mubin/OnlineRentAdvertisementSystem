...
<section class="py-5 bg-dark"><!---->
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center" style="color: white">Use bKash</h2>
                <h2 class="text-center" style="color: white">Payment Process</h2>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Use bKash</h4>
                        <h5 style="color: blue">Manual System</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkashlogo.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 1</h4>
                        <h5 style="color: blue">Dial *247# on your bkash activated mobile phone</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash1.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 2</h4>
                        <h5 style="color: blue">Press '3' to select 'Payment'</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash2.PNG">
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 3</h4>
                        <h5 style="color: blue">Enter '01979996565'</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash3.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 4</h4>
                        <h5 style="color: blue">Enter 'Amount'</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash4.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 5</h4>
                        <h5 style="color: blue">Enter your reference number 'XXXX'</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash5.PNG">
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 6</h4>
                        <h5 style="color: blue">Press '1' to process</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash6.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 7</h4>
                        <h5 style="color: blue">Enter your bKash Menu PIN to confirm payment</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash7.PNG">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card rounded-0"><!--rounded-0 for desing-->
                    <div class="card-header">
                        <h4>Step: 8</h4>
                        <h5 style="color: blue">Customer will receive a payment confirmation SMS</h5>
                    </div>
                    <div class="card-body">
                        <img src="asset/img/bkash8.PNG">
                    </div>
                </div>
