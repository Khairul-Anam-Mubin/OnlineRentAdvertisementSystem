...
<h2 class="text-center" style="color: green"> Restaurant Center Rent Available </h2>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs1.jpg" alt="Card image cap">
                <div class="card-body">

                    <h4>Restaurant Center Rent Available</h4>
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs2.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs3.jpg" alt="Card image cap">
                <div class="card-body">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs4.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs5.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-4 py-3 py-sm-0">
            <div class="card" >
                <img class="card-img-top" src="asset/img/rs6.webp" alt="Card image cap">
                <div class="card-body">
